...
UPC_M_MOD = 'upc_m_mod'
MPN_V_MOD = 'mpn_v_mod'
MPN_M_MOD = 'mpn_m_mod'  # Исправлено с 'mpn_v_mod' на 'mpn_m_mod'

# Cleaning term definitions
terms_by_type = {
   ...
   'General Partnership': ['soc.col.', 'stg', 'd.n.o.', 'ltda.', 'v.o.s.', 'a spol.',
      'veř.obch.spol.', 'kgaa', 'o.e.', 's.f.', 's.n.c.', 's.a.p.a.', 'j.t.d.',
      'v.o.f.', 'sp.j.', 'og', 'sd', ' i/s', 'ay', 'snc', 'oe', 'bt.', 's.s.', 'mb',
      'ans', 'da', 'o.d.', 'hb', 'pt'
   ],
   'Joint Stock / Unlimited': ['unltd', 'ultd', 'sal', 'unlimited', 'saog', 'saoc', 'aj', 'yoaj', 'oaj', 'akc. spol.', 'a.s.'],
   ...
   'Custom Stop Words':['and', '&', 'the', 'product', 'products', "product's", 'companies', 'group', 'groups', "group's", 
   'hardware', 'hdwe', 'commercial', 'mfg', 'mfg.', 'industries', 'technology', 'technologies', 'distributors', 'dis.', 'dist.',
   'intl', 'international', 'CANADA', 'prod', 'manufacturing', 'manufacturer', 'manufacturers', "manufacturer's", 'brand', 'brands', 'intern']
}

terms_by_country = {
   'Albania': ['sh.a.', 'sh.p.k.'],
   'Argentina': ['s.a.', 's.r.l.', 's.c.p.a', 'scpa', 's.c.e i.', 's.e.', 's.g.r', 'soc.col.'],
   'Australia': ['nl', 'pty. ltd.', 'pty ltd'],
   'Austria': ['e.u.', 'stg', 'gesbr', 'a.g.', 'ag', 'og', 'kg'],
   'Belarus': ['aat', '3at'],
   'Belgium': ['esv', 'vzw', 'vof', 'snc', 'comm.v', 'scs', 'bvba', 'sprl', 'cvba', 'cvoa', 'sca', 'sep', 'gie'],
   ...
   'Canada': ['gp', 'lp', 'sp'],
   'Chile': ['eirl', 's.a.', 'sgr', 's.g.r.', 'ltda', 's.p.a.', 'sa', 's. en c.', 'ltda.'],
   'Columbia': ['s.a.', 'e.u.', 's.a.s.', 'suc. de descendants', 'sca'],
   'Croatia': ['d.d.', 'd.o.o.', 'obrt'],
   'Czech Republic': ['a.s.', 'akc. spol.', 's.r.o.', 'spol. s r.o.', 'v.o.s.', 'veř.obch.spol.', 'a spol.', 'k.s.', 'kom. spol.', 'kom. spol.'],
   'Denmark': ['i/s', 'a/s', 'k/s', 'p/s', 'amba', 'a.m.b.a.', 'fmba', 'f.m.b.a.', 'smba', 's.m.b.a.', 'g/s'],
   'Dominican Republic': ['c. por a.', 'cxa', 's.a.', 's.a.s.', 'srl.', 'srl', 'eirl.', 'sa', 'sas'],
   'Ecuador': ['s.a.', 'c.a.', 'sa', 'ep'],
   'Egypt': ['sae'],
   'Estonia': ['fie'],
   'Finland': ['t:mi', 'tmi', 'as oy', 'as.oy', 'ay', 'ky', 'oy', 'oyj', 'ok'],
   'France': ['sicav', 'sarl', 'sogepa', 'ei', 'eurl', 'sasu', 'fcp', 'gie', 'sep', 'snc', 'scs', 'sca', 'scop', 'sem', 'sas'],
   'Germany': ['gmbh & co. kg', 'e.g.', 'e.v.', 'gbr', 'ohg', 'partg', 'kgaa', 'gmbh', 'g.m.b.h.', 'ag', 'mbh & co. kg'],
   'Greece': ['a.e.', 'ae', 'e.e.', 'ee', 'epe', 'e.p.e.', 'mepe', 'm.e.p.e.', 'o.e.', 'oe', 'ovee', 'o.v.e.e.'],
   'Guatemala': ['s.a.', 'sa'],
   'Haiti': ['sa'],
   'Hong Kong': ['ltd', 'unltd', 'ultd', 'limited'],
   'Hungary': ['e.v.', 'e.c.', 'bt.', 'kft.', 'kht.', 'kkt.', 'k.v.', 'zrt.', 'nyrt', 'ev', 'ec', 'rt.'],
   ...
   'Norway': ['asa', 'as', 'ans', 'ba', 'bl', 'da', 'etat', 'fkf', 'hf', 'iks', 'kf', 'ks', 'nuf', 'rhf', 'sf'],
   'Oman': ['saog', 'saoc'],
   'Pakistan': ['ltd.', 'pvt. ltd.', 'ltd', 'limited'],
   'Peru': ['sa', 's.a.', 's.a.a.'],
   'Philippines': ['coop.', 'corp.', 'corp', 'ent.', 'inc.', 'inc', 'llc', 'l.l.c.', 'ltd.'],
   'Poland': ['p.p.', 's.k.a.', 'sp.j.', 'sp.k.', 'sp.p.', 'sp. z.o.o.', 's.c.', 's.a.'],
   'Portugal': ['lda.', 's.a.', 's.f.', 'sgps'],
   'Romania': ['s.c.a.', 's.c.s.', 's.n.c.', 's.r.l.', 'o.n.g.', 's.a.'],
   'Russia': ['ooo', 'oao', 'zao', '3ao', 'пао', 'оао', 'ооо', 'зао'],
   ...
   'Spain': ['s.a.', 's.a.d.', 's.l.', 's.l.l.', 's.l.n.e.', 's.c.', 's.cra', 's.coop', 'sal', 'sccl'],
   'Sweden': ['ab', 'hb', 'kb'],
   'Switzerland': ['ab', 'sa', 'gmbh', 'g.m.b.h.', 'sarl', 'sagl'],
   'Turkey': ['koop.'],
   'Ukraine': ['dat', 'fop', 'kt', 'pt', 'tdv', 'tov', 'pp', 'vat', 'zat', 'at'],
   'United Kingdom': ['plc.', 'plc', 'cic', 'cio', 'l.l.p.', 'llp', 'l.p.', 'lp', 'ltd.', 'ltd', 'limited'],
   ...
   'Custom Stop Words':['usa', 'u.s.a.']
}

# Patterns for cleaning
ALL_PATTERNS = {
    r'in(c(he?s?)?)?': r'[^a-z]in(c(he?s?)?)?[^a-z0-9]', 
    r'us': r'[^a-z]us\d+',
    r'0': r'[\.\,][1-9]*0+$',
    r'x': r'[\d\. ]x\d',
    r'\-xcp[\d]{,9}': r'\-xcp[\d]{,9}$'
...
PATTERNS_LOW = {r'0': r'[\.\,][1-9]*0+$'}

# Default column sets
BASE_COLUMNS = ['key', 'trust', 'type', 'item_code_v', 'prod_id_v', 'prod_id_m',
                'mpn_v', 'mpn_m', 'upc_v', 'upc_m', 'manuf_v', 'raw_manuf_v', 
                'brand_v', 'raw_brand_v', 'manuf_m', 'brand_m', 'ratio_rp',
                'ratio_dkp', 'ratio_cp', 'price_v', 'ret_price_m', 'price_m',
                'title_v', 'title_m', 'cost_v', 'cost_m', 'MinOrV', 'MinOrM',
                'uom_v', 'uom_m', 'pack_size_v', 'pack_size_m', MPN_V_MOD,
                'item_m', 'ven_id', 'removed', 'equal_name_VM', 'ptsr_name',
                'manuf_id_v', 'manuf_id_m', 'brand_id_v', 'brand_id_m',
                'raw_manuf_id_v']